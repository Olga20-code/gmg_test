...
$(document).ready(function () {
  ...
  var cross = spanOne.classList.contains("red"); //timeline with burst and background open

  timelineOpen.add(burst1, burst2, openBackground); //timeline with background close

  timelineClose.add(openBackground); //click on the hamburger
